...
| `--size-header` | `64px` | Высота sticky-шапки |
| `--size-counter` | `18px` | Кружок счётчика в шапке |
| `--size-search-max` | `24rem` | Максимальная ширина поиска в шапке |
